...
import { joinQueue, sendGuess, takeAction } from './mutation.js'
import { generateClient } from 'aws-amplify/api';
import config from './aws-exports';
import { Amplify } from 'aws-amplify';
import { v4 } from 'uuid'
import { Subject, take } from 'rxjs'; // Import Subject from RxJS
...
export function sendAction(client, gameId, playerId, actionId, guessId) {
